...
export default {
  ...
  methods: {
    ...
    validate () {
      if (this.obra.muot_id && this.obra.orig_id && this.obra.obra_fecharecepcion && this.obra.obra_nombre && this.obra.obra_direccion && this.obra.barr_id && this.obra.obra_descripcion) {
        return true
      } else {
        return false
      }
