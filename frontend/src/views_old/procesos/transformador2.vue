<template>
    <el-container>
      <el-main>
      <el-container>
        <el-header class="reporte_header">{{ $t('operativo.transformadortitle') }}
        </el-header>
        <el-main>
...
import { getReportesRango, deleteReporte, getEstados, getTipos, printReporte } from '@/api/transformadorreporte'
...
export default {
  ...
  methods: {
    ...
    handleEdit (index, row) {
      this.$router.push({ path: '/procesos/transformador/editartags/' + row.repo_id })
    ...
    nuevo () {
      this.$router.push({ path: '/procesos/transformador/crear' })
    },
    subreporte () {
