...
export function printReporte (repo_id, empr_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0] + '/api' + '/cnre/prn/repo/' + data.repo_id + '/' + data.empr_id
...
export function printReporteRelacion (fecha_inicial, fecha_final, empr_id, usua_id, tipo) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0] + '/api' + '/cnre/prn/rela/' + data.fecha_inicial + '/' + data.fecha_final + '/' + data.empr_id + '/' + usua_id + '/' + tipo
...
export function printReporteBlanco (reti_id, empr_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0] + '/api' + '/cnre/prn/form/' + data.reti_id + '/' + data.empr_id
  window.open(url, '_blank', 'location=no, menubar=no')
}
