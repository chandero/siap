  ...
  children: [
    {
      ...
      meta: { title: 'menu_solicitud_menu1carta', icon: 'el-icon-message', roles: ['super', 'admin', 'operador', 'gerencia', 'supervisor'] },
      redirect: '/solicitud/menu1carta/menu1-1list',
      children: [
        {
          path: 'menu1-1list',
          ...
          hidden: true,
          meta: { title: 'menu_solicitud_menu1carta_menu1-1list', roles: ['super', 'admin', 'operador', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu1-2create',
          ...
          hidden: true,
          meta: { title: 'menu_solicitud_menu1carta_menu1-2create', roles: ['super', 'operador', 'supervisor'] }
        },
        {
          path: 'menu1-3view/:id',
          ...
          hidden: true,
          meta: { title: 'menu_solicitud_menu1carta_menu1-3view', roles: ['super', 'operador', 'supervisor'] }
        },
        {
          path: 'menu1-4edit/:id',
          ...
          hidden: true,
          meta: { title: 'menu_solicitud_menu1carta_menu1-4edit', roles: ['super', 'operador', 'supervisor'] }
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_solicitud_menu2almacen', icon: 'el-icon-school', roles: ['super', 'operador', 'supervisor'] }
    },
    {
      path: 'menu3detallado',
      component: () => import('@/views/solicitud/menu3detallado'),
      name: 'menu_solicitud_menu3detallado',
      meta: { title: 'menu_solicitud_menu3detallado', icon: 'el-icon-tickets', roles: ['super', 'admin', 'gerencia', 'operador', 'supervisor'] }
    },
    {
      path: 'menu4porvencer',
      component: () => import('@/views/solicitud/menu4porvencer'),
      name: 'menu_solicitud_menu4porvencer',
      meta: { title: 'menu_solicitud_menu4porvencer', icon: 'el-icon-s-comment', roles: ['super', 'admin', 'gerencia', 'operador', 'supervisor'] }
    }
  ]
}
