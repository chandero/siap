...
const informeRouter = {
  ...
  meta: {
    ...
    roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria', 'admininventario']
  },
  children: [
    {
      ...
      children: [
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-1material', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-10materialusadoporreti', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu1-2portipo',
          component: () => import('@/views/informe/menu1consolidado/menu1-2portipo'),
          name: 'menu_informe_menu1consolidado_menu1-2portipo',
          meta: { title: 'menu_informe_menu1consolidado_menu1-2portipo', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu1-3reporte',
          component: () => import('@/views/informe/menu1consolidado/menu1-3reporte'),
          name: 'menu_informe_menu1consolidado_menu1-3reporte',
          meta: { title: 'menu_informe_menu1consolidado_menu1-3reporte', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-8materialcuadrilla', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu1-9reportesinfoto',
          component: () => import('@/views/informe/menu1consolidado/menu1-9reportesinfoto'),
          name: 'menu_informe_menu1consolidado_menu1-9reportesinfoto',
          meta: { title: 'menu_informe_menu1consolidado_menu1-9reportesinfoto', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-4cuadrilla', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-5operaciones', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu1consolidado_menu1-6estadistica', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu1-7aforo',
          component: () => import('@/views/informe/menu1consolidado/menu1-7aforo'),
          name: 'menu_informe_menu1consolidado_menu1-7aforo',
          meta: { title: 'menu_informe_menu1consolidado_menu1-7aforo', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-1material', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-2expansion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-3reubicacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-4modernizacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-5actualizacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-6reposicion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-7repotenciacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          path: 'menu2-8retiro',
          component: () => import('@/views/informe/menu2detallado/menu2-8retiro'),
          name: 'menu_informe_menu2detallado_menu2-8retiro',
          meta: { title: 'menu_informe_menu2detallado_menu2-8retiro', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-9cambiomedida', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-10retirovsreubicacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-11porbarrio', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-12repetido', icon: 'el-icon-info', roles: ['super', 'pqrs'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-13cambiodireccion', icon: 'el-icon-info', roles: ['super', 'pqrs', 'admin', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-14luminariareporte', icon: 'el-icon-info', roles: ['super', 'pqrs', 'admin', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-15obracuadrilla', icon: 'el-icon-info', roles: ['super', 'pqrs', 'admin', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu2detallado_menu2-16reportesinot', icon: 'el-icon-info', roles: ['super', 'pqrs', 'admin', 'gerencia', 'ingeniero', 'supervisor'] }
        }
      ]
    },
    {
      ...
      children: [
        {
          ...
          meta: { title: 'menu_informe_menu3inventario_menu3-1luminaria', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria', 'admininventario'] }
        },
        {
          path: 'menu3-2control',
          component: () => import('@/views/informe/menu3inventario/menu3-2control'),
          name: 'menu_informe_menu3inventario_menu3-2control',
          meta: { title: 'menu_informe_menu3inventario_menu3-2control', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria', 'admininventario'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu3inventario_menu3-3canalizacion', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu3-4poste',
          component: () => import('@/views/informe/menu3inventario/menu3-4poste'),
          name: 'menu_informe_menu3inventario_menu3-4poste',
          meta: { title: 'menu_informe_menu3inventario_menu3-4poste', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          path: 'menu3-5redes',
          component: () => import('@/views/informe/menu3inventario/menu3-5redes'),
          name: 'menu_informe_menu3inventario_menu3-5redes',
          meta: { title: 'menu_informe_menu3inventario_menu3-5redes', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu3inventario_menu3-6transformador', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria', 'admininventario'] }
        },
        {
          path: 'menu3-7medidor',
          component: () => import('@/views/informe/menu3inventario/menu3-7medidor'),
          name: 'menu_informe_menu3inventario_menu3-7medidor',
          meta: { title: 'menu_informe_menu3inventario_menu3-7medidor', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria', 'admininventario'] }
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_informe_menu4calculo', icon: 'el-icon-data-analysis', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_informe_menu4calculo_menu4-1disponibilidad', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu4calculo_menu4-5indisponibilidad', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          path: 'menu4-2carga',
          component: () => import('@/views/informe/menu4calculo/menu4-2carga'),
          name: 'menu_informe_menu4calculo_menu4-2carga',
          meta: { title: 'menu_informe_menu4calculo_menu4-2carga', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          ...
          meta: { title: 'menu_informe_menu4calculo_menu4-3eficiencia', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] }
        },
        {
          path: 'menu4-4ucap',
          component: () => import('@/views/informe/menu4calculo/menu4-4ucap'),
          name: 'menu_informe_menu4calculo_menu4-4ucap',
          meta: { title: 'menu_informe_menu4calculo_menu4-4ucap', icon: 'el-icon-info', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor'] }
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_informe_menu5grafica', icon: 'el-icon-pie-chart', roles: ['super', 'admin', 'pqrs', 'gerencia', 'ingeniero', 'supervisor', 'interventoria'] },
