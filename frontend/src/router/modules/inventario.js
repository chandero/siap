  ...
  children: [
    {
      ...
      meta: { title: 'menu_inventario_menu1luminaria', icon: 'el-icon-grape', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu1luminaria_menu1-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        ...
        { path: 'menu1-1activa/gestion/crear', component: () => import('@/views/inventario/menu1luminaria/menu1-1activa/gestion/create/index'), name: 'gestioncreate', hidden: true, meta: { title: 'gestioncreate', roles: ['super', 'admin', 'ingeniero', 'auxiliar'] } },
        {
          ...
          meta: { title: 'menu_inventario_menu1luminaria_menu1-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_inventario_menu1luminaria_menu1-3porcodigo', icon: 'el-icon-search', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_inventario_menu1luminaria_menu1-6pormaterial', icon: 'el-icon-search', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_inventario_menu1luminaria_menu1-4historia', icon: 'el-icon-document-copy', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu1-5geo',
          component: () => import('@/views/inventario/menu1luminaria/menu1-5geo'),
          name: 'menu_inventario_menu1luminaria_menu1-5geo',
          meta: { title: 'menu_inventario_menu1luminaria_menu1-5geo', icon: 'el-icon-location-information', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_inventario_menu2control', icon: 'el-icon-watermelon', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu2control_menu2-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu2-2enbaja',
          component: () => import('@/views/inventario/menu2control/menu2-2enbaja'),
          name: 'menu_inventario_menu2control_menu2-2enbaja',
          meta: { title: 'menu_inventario_menu2control_menu2-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
    ...
    },
    {
      ...
      meta: { title: 'menu_inventario_menu3canalizacion', icon: 'el-icon-cherry', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu3canalizacion_menu3-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu3-2enbaja',
          component: () => import('@/views/inventario/menu3canalizacion/menu3-2enbaja'),
          name: 'menu_inventario_menu3canalizacion_menu3-2enbaja',
          meta: { title: 'menu_inventario_menu3canalizacion_menu3-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
    ...
    },
    {
      ...
      meta: { title: 'menu_inventario_menu4poste', icon: 'el-icon-wind-power', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu4poste_menu4-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu4-2enbaja',
          component: () => import('@/views/inventario/menu4poste/menu4-2enbaja'),
          name: 'menu_inventario_menu4poste_menu4-2enbaja',
          meta: { title: 'menu_inventario_menu4poste_menu4-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
    ...
    },
    {
      ...
      meta: { title: 'menu_inventario_menu5redes', icon: 'el-icon-phone-outline', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu5redes_menu5-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu5-2enbaja',
          component: () => import('@/views/inventario/menu5redes/menu5-2enbaja'),
          name: 'menu_inventario_menu5redes_menu5-2enbaja',
          meta: { title: 'menu_inventario_menu5redes_menu5-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
    ...
    },
    {
      ...
      meta: { title: 'menu_inventario_menu6transformador', icon: 'el-icon-c-scale-to-original', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_inventario_menu6transformador_menu6-1activa', icon: 'el-icon-sunrise', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
        {
          path: 'menu6-2enbaja',
          component: () => import('@/views/inventario/menu6transformador/menu6-2enbaja'),
          name: 'menu_inventario_menu6transformador_menu6-2enbaja',
          meta: { title: 'menu_inventario_menu6transformador_menu6-2enbaja', icon: 'el-icon-sunset', roles: ['super', 'admin', 'auxiliar', 'gerencia', 'supervisor'] }
        },
