      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-1interna_menu4-1-2create', roles: ['super', 'auxiliar', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-1interna_menu4-1-3edit', roles: ['super', 'auxiliar', 'supervisor'] }
            }
          ]
        },
        {
