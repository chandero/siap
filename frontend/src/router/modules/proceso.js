...
const procesoRouter = {
  ...
  children: [
      ...
      children: [
        {
          ...
          component: () =>
            import('@/views/proceso/menu1reporte/menu1-1luminaria'),
          ...
          children: [
            ...
            {
              path: 'menu1-1-4elemento/:id',
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-1luminaria/menu1-1-4elemento'
                ),
              name:
        ...
        },
        {
          path: 'menu1-2control',
          component: () =>
            import('@/views/proceso/menu1reporte/menu1-2control'),
        ...
        },
        {
          ...
          component: () =>
            import('@/views/proceso/menu1reporte/menu1-3canalizacion'),
          ...
          children: [
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-3canalizacion/menu1-3-1list'
                ),
              name:
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-3canalizacion/menu1-3-2create'
                ),
              name:
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-3canalizacion/menu1-3-3edit'
                ),
              name:
                'menu_proceso_menu1reporte_menu1-3canalizacion_menu1-3-3create',
              hidden: true,
              meta: {
                title:
          ...
          children: [
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-4poste/menu1-4-1list'
                ),
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-4poste/menu1-4-2create'
                ),
              name:
                'menu_proceso_menu1reporte_menu1-3canalizacion_menu1-4-2create',
              hidden: true,
              meta: {
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-4poste/menu1-4-3edit'
                ),
          ...
          children: [
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-5redes/menu1-5-1list'
                ),
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-5redes/menu1-5-2create'
                ),
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu1reporte/menu1-5redes/menu1-5-3edit'
                ),
        ...
        },
        {
          ...
          component: () =>
            import('@/views/proceso/menu1reporte/menu1-6transformador'),
    ...
    },
    {
      ...
      meta: {
        title: 'menu_proceso_menu8cuadrilla',
        icon: 'el-icon-s-unfold',
        roles: [
          'super',
          'admin',
      ...
      children: [
        {
          ...
          meta: {
            ...
            icon: 'el-icon-s-order',
            roles: ['super', 'admin', 'pqrs', 'ingeniero']
          }
        },
        {
          path: 'menu3-2create',
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () =>
                import(
                  '@/views/proceso/menu4orden/menu4-2externa/menu4-2-4info'
                ),
        ...
        },
        {
          ...
          meta: {
            ...
            icon: 'el-icon-receiving',
            roles: ['super', 'pqrs', 'ingeniero', 'facturacion']
          },
