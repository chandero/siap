...
const procesoRouter = {
  ...
  children: [
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-1luminaria_menu1-1-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              path: 'menu1-1-2create',
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-1luminaria_menu1-1-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-1luminaria_menu1-1-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu1reporte_menu1-2control', icon: 'el-icon-watermelon', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-2control_menu1-2-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-2control_menu1-2-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-2control_menu1-2-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu1reporte_menu1-3canalizacion', icon: 'el-icon-cherry', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-3canalizacion_menu1-3-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-3canalizacion_menu1-3-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-3canalizacion_menu1-3-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu1reporte_menu1-4poste', icon: 'el-icon-wind-power', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-4poste_menu1-4-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-4poste_menu1-4-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-4poste_menu1-4-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu1reporte_menu1-5redes', icon: 'el-icon-phone-outline', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-5redes_menu1-5-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-5redes_menu1-5-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-5redes_menu1-5-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu1reporte_menu1-6transformador', icon: 'el-icon-phone-outline', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-6transformador_menu1-6-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-6transformador_menu1-6-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu1reporte_menu1-6transformador_menu1-6-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_proceso_menu2pendiente', icon: 'el-icon-s-unfold', roles: ['super', 'admin', 'operador', 'gerencia', 'supervisor'] }
    },
    {
      path: 'menu5formato',
      component: () => import('@/views/proceso/menu5formato/index'), // Parent router-view
      name: 'menu_proceso_menu5formato',
      meta: { title: 'menu_proceso_menu5formato', icon: 'el-icon-edit-outline', roles: ['super', 'admin', 'operador', 'gerencia', 'supervisor'] }
    },
    {
      path: 'menu3obra',
      component: () => import('@/views/proceso/menu3obra/index'), // Parent router-view
      name: 'menu_proceso_menu3obra',
      meta: { title: 'menu_proceso_menu3obra', icon: 'el-icon-picture-outline-round', roles: ['super', 'admin', 'operador', 'supervisor'] },
      children: [
        {
          path: 'menu3-1list',
          component: () => import('@/views/proceso/menu3obra/menu3-1list'),
          name: 'menu_proceso_menu3obra_menu3-1list',
          meta: { title: 'menu_proceso_menu3obra_menu3-1list', icon: 'el-icon-s-order', roles: ['super', 'admin', 'operador', 'supervisor'] }
        },
        {
          path: 'menu3-2create',
          ...
          hidden: true,
          meta: { title: 'menu_proceso_menu3obra_menu3-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
        },
        {
          path: 'menu3-3edit/:id',
          ...
          hidden: true,
          meta: { title: 'menu_proceso_menu3obra_menu3-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
        },
        {
          ...
          meta: { title: 'menu_proceso_menu3obra_menu3-4pendiente', icon: 'el-icon-s-unfold', roles: ['super', 'admin', 'operador', 'supervisor'] }
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_proceso_menu4orden', icon: 'el-icon-document-add', roles: ['super', 'admin', 'operador', 'supervisor'] },
      ...
      children: [
        {
          ...
          meta: { title: 'menu_proceso_menu4orden_menu4-1interna', icon: 'el-icon-truck', roles: ['super', 'admin', 'operador', 'supervisor'] },
          redirect: '/proceso/menu4orden/menu4-1interna/menu4-1-1list',
          children: [
            {
              path: 'menu4-1-1list',
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-1interna_menu4-1-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-1interna_menu4-1-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-1interna_menu4-1-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        },
        {
          ...
          meta: { title: 'menu_proceso_menu4orden_menu4-2externa', icon: 'el-icon-receiving', roles: ['super', 'admin', 'operador', 'supervisor'] },
          ...
          children: [
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-2externa_menu4-2-1list', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-2externa_menu4-2-2create', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-2externa_menu4-2-3edit', roles: ['super', 'admin', 'operador', 'supervisor'] }
            },
            {
              ...
              hidden: true,
              meta: { title: 'menu_proceso_menu4orden_menu4-2externa_menu4-2-4info', roles: ['super', 'admin', 'operador', 'supervisor'] }
            }
          ]
        }
      ]
    },
    {
      ...
      meta: { title: 'menu_proceso_menu6recuperar', icon: 'el-icon-refresh-right', roles: ['super', 'operador'] }
    }
  ]
}
