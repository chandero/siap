  ...
  */
  ...
  auditorRouter,
  {
    ...
    children: [
      ...
      { path: 'unitario', component: _import('administracion/unitario'), name: 'unitario', meta: { title: 'unitario', roles: ['super', 'admin'] } },
      { path: 'unitario/editar/:id', component: _import('administracion/unitario/edit'), name: 'unitarioedit', hidden: true, redirect: false, meta: { title: 'unitarioedit', roles: ['super'] } },
      { path: 'unitario/crear', component: _import('administracion/unitario/create'), name: 'unitariocreate', hidden: true, meta: { title: 'unitariocreate', roles: ['super'] } },
      ...
      // ELEMENTO
      {
        ...
        children: [
          {
            path: 'ipp',
            component: () => import('@/views/administracion/elemento/menu04/index'),
            name: 'ucap_ipp',
            meta: { title: 'ipp.lista', icon: 'el-icon-notebook-2', roles: ['super', 'admin', 'auxiliar', 'supervisor'] }
          },
          {
            path: 'list',
