...
import { informe_siap_general_operaciones_xls } from '@/api/informe'
export default {
  data () {
    return {
      labelPosition: 'top',
  ...
  methods: {
    obtenerDatos () {
      informe_siap_general_operaciones_xls(this.fecha_inicial.getTime(), this.fecha_final.getTime(), 'xls', this.empresa.empr_id)
    }
  }
}
</script>
