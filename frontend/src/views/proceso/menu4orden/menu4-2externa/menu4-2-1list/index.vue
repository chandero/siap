...
export default {
  ...
  methods: {
    handleEdit (index, row) {
      this.$router.push({ path: '/proceso/menu4orden/menu4-2externa/menu4-2-3edit/' + row.muob_id })
      console.log(index, row)
    },
    handleInforme (index, row) {
      this.$router.push({ path: '/proceso/menu4orden/menu4-2externa/menu4-2-4info/' + row.muob_consecutivo })
      console.log(index, row)
    },
    ...
    nuevo () {
      this.$router.push({ path: '/proceso/menu4orden/menu4-2externa/menu4-2-2create' })
    },
    getMuob () {
      getMuobs()
        .then(response => {
