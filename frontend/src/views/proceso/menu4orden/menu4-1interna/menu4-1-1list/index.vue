...
export default {
  ...
  methods: {
    ...
    handleEdit (index, row) {
      this.$router.push({ path: '/proceso/menu4orden/menu4-1interna/menu4-1-3edit/' + row.ortr_id })
    ...
    nuevo () {
      this.$router.push({ path: '/proceso/menu4orden/menu4-1interna/menu4-1-2create' })
    }
  },
  mounted () {
    this.getOrdenes()
