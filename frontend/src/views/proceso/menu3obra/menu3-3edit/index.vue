<template>
  <el-container>
      <el-header>
          <span>{{ $t('route.obraedit') }} - Estado Actual: {{ estado() }}</span>
      </el-header>
      <el-main>
          <el-form ref="obraForm" :model="obra" :label-position="labelPosition">
                    ...
                    <el-row :gutter="4">
                        ...
                        <el-col :xs="24" :sm="24" :md="10" :lg="10" :xl="10">
                            <el-form-item prop="reti_id" :label="$t('obra.type')">
                                <span style="font-size: 24px;">{{ obra_tipo(obra.reti_id) }}</span>
                            </el-form-item>
                        </el-col>
                        -->
                        <!--
