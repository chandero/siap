...
export function informe_siap_detallado_material(fecha_inicial, fecha_final, usua_id, empr_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + 's/api' + '/info/sdm/' + data.fecha_inicial + '/' + data.fecha_final + '/' + data.usua_id + '/' + data.empr_id
  window.open(url, '_blank', 'location=no, menubar=no')
}
...
export function informe_siap_poste_xls(empr_id) {
  ...
  const token = '43f44388-5cd1-4657-9f7e-ea4e014e9333'
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + '/api' + '/info/spx/' + data.empr_id + '/' + token
  window.open(url, '_self', 'location=no, menubar=no')
}
...
export function informe_siap_redes_xls(empr_id) {
  ...
  const token = '43f44388-5cd1-4657-9f7e-ea4e014e9333'
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + '/api' + '/info/srx/' + data.empr_id + '/' + token
  window.open(url, '_self', 'location=no, menubar=no')
}
