...
export function printObra(obra_id, empr_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + ':9091/api' + '/obra/prn/obra/' + data.obra_id + '/' + data.empr_id
...
export function printObraRelacion(fecha_inicial, fecha_final, empr_id, usua_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + ':9091/api' + '/obra/prn/rela/' + data.fecha_inicial + '/' + data.fecha_final + '/' + data.empr_id + '/' + usua_id
  window.open(url, '_blank', 'location=no, menubar=no')
}
...
export function printObraBlanco(reti_id, empr_id) {
  ...
  const url = window.location.protocol + '//' + window.location.host.split('/')[0].split(':')[0] + ':9091/api' + '/obra/prn/form/' + data.reti_id + '/' + data.empr_id
  window.open(url, '_blank', 'location=no, menubar=no')
}
