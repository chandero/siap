<template>
    <el-container>
           ...
           <el-row :gutter="4">
             <el-col :span="12">
               <el-form-item :label="$t('gestion.code')">
                <el-input :disabled="!invalid" autofocus name="code" v-validate="'required|numeric'" type="number" v-model="activo.aap.aap_id" @input="activo.aap.aap_id = parseInt($event)" ref="code" @blur="validarNumero($event)" @keyup.enter.native="changeFocus('support')"></el-input>
                <span>{{ errors.first('code')}}</span>
               </el-form-item>
             </el-col>
             <el-col :span="12"><el-form-item :label="$t('gestion.support')">
                      <el-input v-model="activo.aap.aap_apoyo"  ref="support" @keyup.enter.native="changeFocus('description')"></el-input>
                     </el-form-item> 
             </el-col>
           </el-row>
          </el-collapse-item>
            ...
            <el-row :gutter="4">
              ...
              <el-col :xs="24" :sm="24" :md="14" :lg="14" :xl="14">
                <el-form-item :label="$t('gestion.address')">
                 <el-input ref="address" v-model="activo.aap.aap_direccion" @input="activo.aap.aap_direccion = $event.toUpperCase()" @keyup.enter.native="changeFocus('neighborhood')">
            ...
            <el-row :gutter="4">
              ...
              <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
                <el-form-item :label="$t('gestion.brand')">
                  <el-select clearable filterable ref="brand" v-model="activo.aap.aama_id" name="brand" :placeholder="$t('brand.select')" @change="changeFocus('model')">
              ...
              <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
                <el-form-item :label="$t('gestion.model')">
                  <el-select clearable filterable ref="model" v-model="activo.aap.aamo_id" name="model" :placeholder="$t('model.select')" @change="changeFocus('cover')">
            ...
            <el-row :gutter="4">
              <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                <el-form-item :label="$t('gestion.cover')">
                  <el-select clearable filterable ref="cover" v-model="activo.aap.aatc_id" name="cover" :placeholder="$t('cover.select')" @change="changeFocus('use')">
              ...
              <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                <el-form-item :label="$t('gestion.use')">
                  <el-select clearable filterable ref="use" v-model="activo.aap.aaus_id" name="use" :placeholder="$t('use.select')" @change="changeFocus('connection')">
              ...
              <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                <el-form-item :label="$t('gestion.connection.title')">
                 <el-select clearable filterable ref="connection" v-model="activo.aap.aaco_id" name="conexion" :placeholder="$t('gestion.connection.select')" @change="validateConnection()">
            ...
            <el-row :gutter="4">
              <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
                <el-form-item :label="$t('gestion.tecnology.title')">
                  <el-select clearable filterable ref="tecnology" v-model="activo.aap_adicional.aap_tecnologia" name="tecnology" :placeholder="$t('gestion.tecnology.select')">
              ...
              <el-col :xs="24" :sm="6" :md="6" :lg="6" :xl="6">
                <el-form-item :label="$t('gestion.power.title')">
                  <el-select clearable filterable ref="power" v-model="activo.aap_adicional.aap_potencia" name="power" :placeholder="$t('gestion.power.select')">
              ...
              <el-col :xs="24" :sm="6" :md="6" :lg="6" :xl="6">
                <el-form-item :label="$t('gestion.post.title')">
                  <el-select clearable filterable ref="post" v-model="activo.aap_adicional.tipo_id" name="post" :placeholder="$t('gestion.post.select')">
              ...
              <el-col :xs="24" :sm="4" :md="4" :lg="4" :xl="4">
                <el-form-item :label="$t('gestion.post.size')">
                  <el-input ref="postsize" v-model="activo.aap_adicional.aap_poste_altura" @input="activo.aap_adicional.aap_poste_altura=parseFloat($event)" name="postsize" />
                </el-form-item>
              </el-col>                          
            </el-row>
            ...
            <el-row :gutter="4">
              <el-col :xs="24" :sm="8" :md="8" :lg="8" :xl="8">
                <el-form-item :label="$t('gestion.post.own')">
                  <el-select clearable filterable ref="postown" v-model="activo.aap_adicional.aap_poste_propietario" name="postown" :placeholder="$t('gestion.post.selectown')">
            ...
            <el-row :gutter="4">
              ...
              <el-col v-if="activo.aap.aap_modernizada" :xs="24" :sm="4" :md="4" :lg="4" :xl="4">
                <el-form-item :label="$t('gestion.modernyear')">
                  <el-input type="number" name="modernyear" ref="modernyear" v-model="activo.aap_adicional.aap_modernizada_anho"></el-input>
                </el-form-item>
              </el-col>              
     ...
     <el-footer>
      <el-button :disabled="!validate()" ref="submit" size="medium" type="primary" icon="el-icon-check" @click="aplicar">Guardar Luminaria</el-button>
     </el-footer>
    </el-container>
</template>
<script>
...
import { saveAap, buscarSiguiente, validar } from '@/api/aap'
...
export default {
  ...
  methods: {
    validarNumero() {
      ...
      buscarSiguiente().then(response => {
        if (this.activo.aap.aap_id !== response.data) {
          this.$prompt('Por favor ingrese el código de autorización si lo tiene:', 'El consecutivo digitado no es el siguiente', {
            confirmButtonText: 'Confirmar',
            cancelButtonText: 'Cancelar'
          }).then(({ value }) => {
            validar(1, value).then(response => {
    ...
    validate() {
      ...
      if (this.activo.aap.aap_id !== null &&
