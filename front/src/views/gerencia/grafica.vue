...
import { siap_lista_potencias, siap_lista_tecnologias, siap_lista_medidas, siap_lista_sectores, siap_lista_usos, siap_lista_barrios, siap_lista_veredas,
  ...
  siap_grafica_reporte_barrio, siap_lista_reporte_barrio, siap_grafica_reporte_vereda } from '@/api/grafica'
