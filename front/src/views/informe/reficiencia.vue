...
import { informe_siap_eficiencia_xls } from '@/api/informe'
export default {
  data() {
    return {
      labelPosition: 'top',
  ...
  methods: {
    obtenerDatos() {
      informe_siap_eficiencia_xls(this.fecha_inicial.getTime(), this.fecha_final.getTime(), this.empresa.empr_id)
    }
  }
}
</script>
