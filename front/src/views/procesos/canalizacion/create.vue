<template>
  <el-container>
      <el-header>
          <span>{{ $t('route.canalizacionreportecreate') }}</span>
      </el-header>
      <el-main>
...
import { saveReporte, printReporte, getTipos } from '@/api/canalizacionreporte'
import { getActividades, saveActividad } from '@/api/actividad'
import { getAap, getAapApoyo } from '@/api/canalizacion'
