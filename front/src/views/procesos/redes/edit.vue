...
import { getReporte, updateReporte, getTipos, getEstados, validarCodigo, validarReporteDiligenciado } from '@/api/postereporte'
import { getAcciones } from '@/api/accion'
import { getElementos, getElementoByDescripcion } from '@/api/elemento'
import { getAapEdit, getAapValidar, validar } from '@/api/poste'
