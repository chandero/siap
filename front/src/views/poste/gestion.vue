...
import { getTodos } from '@/api/poste'
import { deleteAap } from '@/api/poste'
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      this.$router.push({ path: '/poste/gestion/editar/' + row.aap_id })
    ...
    nuevo() {
      this.$router.push({ path: '/poste/gestion/crear' })
    },
    actualizar() {
      this.getAaps()
    },
