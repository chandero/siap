<template>
    <el-container class="box-card">
      <el-header>
          <span>{{ $t('route.controlgestionedit') }}</span>
      </el-header>
    <el-main>
     ...
     <el-footer>
      <el-button ref="submit" :disabled="!validate()" size="medium" type="primary" icon="el-icon-check" @click="aplicar">Guardar Poste</el-button>
     </el-footer>
    </el-container>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    limpiarAndBack() {
      this.limpiar()
      this.$router.push({ path: '/poste/gestion' })
    },
    limpiar() {
      this.poste = {
        aap_id: null,
