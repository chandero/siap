...
object Siap_inventario_b {
  implicit val sibWrites = new Writes[Siap_inventario_b] {
    def writes(sib: Siap_inventario_b) = Json.obj(
      ...
      "aap_codigo" -> sib.aap_codigo,
      "aap_numero" -> sib.aap_numero
    )
  }
}
...
object Siap_detallado_material {
  ...
  implicit val srmWrites = new Writes[Siap_detallado_material] {
    def writes(srm: Siap_detallado_material) = Json.obj(
      ...
      "even_cantidad_instalado" -> srm.even_cantidad_instalado,
      "cuad_descripcion" -> srm.cuad_descripcion
    )
  }
}
...
case class Siap_detallado_expansion(
    repo_tipo_expansion: Option[String],
    repo_fechasolucion: Option[DateTime],
  ...
  val _set = {
    get[Option[Int]]("repo_consecutivo") ~
      ...
      case repo_consecutivo ~
            ...
            cuad_descripcion ~
            luminarias =>
        new Siap_luminaria_por_reporte(
          repo_consecutivo,
          repo_fecharecepcion,
          repo_fechalimite,
          repo_fechasolucion,
...
object Siap_detallado_expansion {
  ...
  implicit val sdeWrites = new Writes[Siap_detallado_expansion] {
    def writes(srm: Siap_detallado_expansion) = Json.obj(
      "repo_tipo_expansion" -> srm.repo_tipo_expansion,
      "repo_fechasolucion" -> srm.repo_fechasolucion,
  ...
  val siap_detallado_expansion_set = {
    get[Option[String]]("repo_tipo_expansion") ~
      get[Option[DateTime]]("repo_fechasolucion") ~
...
object Siap_detallado_cambio_medida {
  ...
  val _set = {
    get[Option[DateTime]]("repo_fechasolucion") ~
      ...
      get[Option[String]]("aaco_descripcion") ~
      get[Option[String]]("medi_codigo") ~
      get[Option[String]]("aap_codigo") map {
      case repo_fechasolucion ~
            repo_fechadigitacion ~
            aap_rte ~
            aap_id ~
  ...
  val _set = {
    get[Option[DateTime]]("ortr_fecha") ~
      ...
      case ortr_fecha ~
            ...
            rural ~
            operaciones =>
        new Siap_informe_por_cuadrilla(
          ortr_fecha,
          None,
          cuad_descripcion,
          cuad_responsable,
...
ORDER BY e.reti_id, e.elem_codigo""")
        ...
        SQL("""
          select 
            ...
            from (SELECT ot1.ortr_fecha, c1.cuad_descripcion, e1.elem_codigo, e1.elem_descripcion,rt1.reti_descripcion, 
                    ...
                    left join siap.cuadrilla c1 on c1.cuad_id = ot1.cuad_id
                    WHERE ot1.ortr_fecha BETWEEN {fecha_inicial} and {fecha_final} and r1.rees_id < 9 and re1.even_estado <> 9 and r1.empr_id = {empr_id} and c1.cuad_id = {cuad_id}
                    UNION ALL
  ...
  /**
    * return sql response to excel export
    * resumen material reporte bodega
    */
  def siap_consolidado_material_por_bodega_xls(
      fecha_inicial: scala.Long,
      fecha_final: scala.Long,
      empr_id: scala.Long
  ): Future[Iterable[(String, String, String, Int, Int)]] =
    Future[Iterable[(String, String, String, Int, Int)]] {
      db.withConnection { implicit connection =>
        var fi = Calendar.getInstance()
        var ff = Calendar.getInstance()
        ...
        ff.set(Calendar.MINUTE, 59)
        ff.set(Calendar.HOUR, 23)
        val parser = str("reti_descripcion") ~ str("elem_codigo") ~ str("elem_descripcion") ~ int("even_cantidad_retirado") ~ int("even_cantidad_instalado") map {
          case reti_descripcion ~ elem_codigo ~ elem_descripcion ~ even_cantidad_retirado ~ even_cantidad_instalado =>
  ...
  /**
    ...
    * resumen material por cuadrilla reporte
    */
  def siap_cuadrilla_consolidado_material_xlsx(
      fecha_inicial: scala.Long,
      fecha_final: scala.Long,
      cuad_id: scala.Long,
      empr_id: scala.Long,
      ...
      db.withConnection { implicit connection =>
        ...
        val sheet = Sheet(
          ...
          rows = {
            ...
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues("Material Cuadrilla:", cuadrilla match { 
                  case Some(c) => c.cuad_descripcion
                  case None => "Cuadrilla no encontrada"
                })
            _listRow += com.norbitltd.spoiwo.model
                .Row()
            ...
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues("Fecha","Cuadrilla","Tipo de Reporte","Código Material","Descripción Material","Cantidad Retirado", "Cantidad Instalado")
            resultSet.map {
            i =>
              _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues(
                  i.ortr_fecha match { case Some(f) => df.print(f) case None => "" },
                  i.cuad_descripcion match { case Some(c) => c case None => "" },
                  i.reti_descripcion match { case Some(r) => r case None => "" },
                  i.elem_codigo match { case Some(e) => e case None => "" },
                  i.elem_descripcion match { case Some(e) => e case None => "" },
                  i.even_cantidad_retirado match { case Some(e) => e case None => 0 },
                  i.even_cantidad_instalado match { case Some(e) => e case None => 0 }
                )
          }
          _listRow.toList
        },
  ...
  /**
    ...
    * resumen material por cuadrilla reporte
    */
  def siap_consolidado_material_por_bodega_xlsx(
      fecha_inicial: scala.Long,
      fecha_final: scala.Long,
      empr_id: scala.Long,
      usua_id: scala.Long
  ): Array[Byte] =
     {
      db.withConnection { implicit connection =>
        ...
        val usuario = usuarioService.buscarPorId(usua_id)
        println("Leyendo Datos...")
        val parser = get[Option[String]]("reti_descripcion") ~ get[Option[String]]("elem_codigo") ~ get[Option[String]]("elem_descripcion") ~ get[Option[Double]]("even_cantidad_retirado") ~ get[Option[Double]]("even_cantidad_instalado") map {
          case reti_descripcion ~ elem_codigo ~ elem_descripcion ~ even_cantidad_retirado ~ even_cantidad_instalado =>
            (reti_descripcion, elem_codigo, elem_descripcion, even_cantidad_retirado, even_cantidad_instalado)
        }
        val resultSet = SQL("""
...
ORDER BY e.reti_id, e.elem_codigo        """)
        ...
        val dtf = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss")
        val sheet = Sheet(
          name = "Material Por Tipo de Reporte",
          rows = {
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues(empresa match { case Some(e) => e.empr_descripcion case None => ""})
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues("Fecha Inicial:" + df.print(fi.getTimeInMillis()) + " Fecha Final:" + df.print(ff.getTimeInMillis()))
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues("Fecha del Informe:", dtf.print(DateTime.now()))
            _listRow += com.norbitltd.spoiwo.model
            ...
            _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues("Tipo de Reporte","Código Material","Descripción Material","Cantidad Retirado", "Cantidad Instalado")
            resultSet.map {
            i =>
              _listRow += com.norbitltd.spoiwo.model
                .Row()
                .withCellValues(
                  i._1 match { case Some(r) => r case None => "" },
                  i._2 match { case Some(e) => e case None => "" },
                  i._3 match { case Some(e) => e case None => "" },
                  i._4 match { case Some(e) => e case None => 0D },
                  i._5 match { case Some(e) => e case None => 0D }
                )
          }
          _listRow.toList
        },
        ...
        columns = {
               ...
               _listColumn += com.norbitltd.spoiwo.model
                .Column(index = 1, width = new Width(20, WidthUnit.Character))
               _listColumn += com.norbitltd.spoiwo.model
    ...
    Future[Iterable[Siap_detallado_cambio_medida]] {
      db.withConnection { implicit connection =>
        ...
        SQL("""select distinct
            ...
            co.aaco_descripcion,
            m.medi_numero,
            t.aap_numero from siap.reporte r
            left join siap.reporte_adicional ra on ra.repo_id = r.repo_id
            ...
            left join siap.transformador t on t.aap_id = ra.aap_id
  ...
  def siap_reporte_consolidado_xls(
    ...
    select distinct 
    	...
    	r.repo_reportetecnico
    	from siap.medidor_reporte r 
    	left join siap.medidor_reporte_adicional ra on ra.repo_id = r.repo_id
    	left join siap.barrio b on b.barr_id = r.barr_id
    	left join siap.origen o on o.orig_id = r.orig_id
    	left join siap.actividad a on a.acti_id = ra.acti_id
    	where r.reti_id = 1 and r.repo_fecharecepcion between {fecha_inicial} and {fecha_final} and r.empr_id = {empr_id} and r.rees_id = 3
    ...
    select distinct 
    	...
    	r.repo_reportetecnico
    	from siap.transformador_reporte r 
    	left join siap.transformador_reporte_adicional ra on ra.repo_id = r.repo_id
    	left join siap.barrio b on b.barr_id = r.barr_id
    	left join siap.origen o on o.orig_id = r.orig_id
    	left join siap.actividad a on a.acti_id = ra.acti_id
    	where r.reti_id = 1 and r.repo_fecharecepcion between {fecha_inicial} and {fecha_final} and r.empr_id = {empr_id} and r.rees_id = 3) as r
        ...
        case Some(empresa) =>
          ...
          val resultSet = SQL(
            """SELECT m.*, b.barr_descripcion, tp.tipo_descripcion, COUNT(a.*) AS cantidad FROM siap.transformador m
                                 ...
                                 WHERE m.empr_id = {empr_id}
                                 GROUP BY m.aap_id, m.aap_numero, m.aap_direccion, b.barr_descripcion, tp.tipo_descripcion"""
          ).on(
              'empr_id -> empr_id
            )
            .as(InformeT._set *)
          val sheet1 = Sheet(
            ...
            rows = {
              ...
              val rows = resultSet.map {
                med =>
                  j += 1
                  val link = new HyperLinkUrl(med.aap_numero.get, "#T" + med.aap_numero.get)
                  com.norbitltd.spoiwo.model.Row(
                    HyperLinkUrlCell(
                      link,
                      Some(0),
            ...
            val sheet = Sheet(
              ...
              rows = {
                ...
                val aapSet =
                 ...
                 LEFT JOIN siap.aap_transformador at ON at.aap_id = a.aap_id and at.empr_id = a.empr_id
                 LEFT JOIN siap.transformador t ON t.aap_id = at.aap_id and t.empr_id = at.empr_id
                 WHERE a.empr_id = {empr_id} and a.esta_id <> 9 and a.aap_id <> 9999999 and t.aap_id = {aap_id}
                                ORDER BY a.aap_id ASC
                                """)
                    .on(
                      'empr_id -> empr_id,
        ...
        val sheet = Sheet(
          ...
          rows = {
            ...
            val titleRow2 = com.norbitltd.spoiwo.model
              .Row()
              .withCellValues(
                "Informe Detallado de Cambio de Dirección por Reporte"
              )
...
select r.* from (select r.*, a.*, o.*, rt.*, t.*, b.*, ((r.repo_fecharecepcion + interval '48h')::timestamp + (SELECT COUNT(*) FROM siap.festivo WHERE fest_dia BETWEEN r.repo_fecharecepcion and (r.repo_fecharecepcion + interval '48h')) * '1 day'::interval ) as fecha_limite,  c.cuad_descripcion from siap.reporte r
              ...
              i =>
                ...
                _listRow03 += com.norbitltd.spoiwo.model.Row(
                  ...
                  StringCell(
                    i._1 match {
                      case Some(i) => i
                      case None    => "Sin Asignar Orden de Trabajo"
                    },
                    Some(1),
                    style = Some(
                      CellStyle(dataFormat = CellDataFormat("@"))
  ...
  def siap_informe_obra_cuadrilla_xls(
    ...
    Future[Iterable[Siap_obra_cuadrilla]] {
      ...
      db.withConnection { implicit connection =>
        ...
        var query =
          """SELECT o1.obra_consecutivo, o1.muot_id, o1.obra_fecharecepcion, o1.obra_fechasolucion, o1.obra_nombre, o1.obra_direccion, b1.barr_descripcion, ot.ortr_consecutivo, c1.cuad_descripcion FROM siap.obra o1
  ...
  def siap_informe_general_estadistica_xls(
    ...
    val sheet01 = siap_informe_general_estadistica_tipo_reporte_xls(
      fi,
      ff,
      empr_id,
      periodos
    ...
    val sheet02 =
      siap_informe_general_estadistica_origen_xls(fi, ff, empr_id, periodos)
    val sheet03 =
      siap_informe_general_estadistica_cuadrilla_xls(fi, ff, empr_id, periodos)
    val sheet04 =
      siap_informe_general_estadistica_luminaria_xls(fi, ff, empr_id, periodos)
    var os: ByteArrayOutputStream = new ByteArrayOutputStream()
    Workbook(sheet01, sheet02, sheet03, sheet04).writeToOutputStream(os)
    println("Stream Listo")
    os.toByteArray
      ...
      val sheet01 = Sheet(
        ...
        rows = {
          ...
          val titleRow2 = com.norbitltd.spoiwo.model
            .Row(
              StringCell(
                ...
                Some(0),
                style = Some(
                  CellStyle(dataFormat = CellDataFormat("@"), font = fuente)
                ),
                CellStyleInheritance.CellThenRowThenColumnThenSheet
              )
            )
          ...
          var cell = StringCell(
            ...
            Some(0),
            style =
              Some(CellStyle(dataFormat = CellDataFormat("@"), font = fuente)),
            CellStyleInheritance.CellThenRowThenColumnThenSheet
          )
          ...
          var x = 0
          for (x <- 1 to periodos) {
            val etiqueta = Utility
              .mes(fecha_tmp.get(Calendar.MONTH) + 1) + fecha_tmp.get(
              Calendar.YEAR
            )
            val position = x + 1
            val cell = StringCell(
          ...
          _listRow01 += headerRow
          val _parser01: RowParser[scala.collection.mutable.Map[String, Any]] =
            SqlParser.folder(scala.collection.mutable.Map.empty[String, Any]) {
              (map, value, meta) =>
          ...
          var rows = resultSet.map {
            i =>
              ...
              fecha_tmp.setTime(fi.getTime())
              for (x <- 1 to periodos) {
                val etiqueta = "." + Utility.mes(
                  fecha_tmp.get(Calendar.MONTH) + 1
                ) + fecha_tmp.get(Calendar.YEAR)
                cell = NumericCell(
                  i.get(etiqueta.toLowerCase()) match {
              ...
              var cell1 = Cell.Empty
              cell1 = FormulaCell(
                "SUM(C" + (_csc + 5) + ":" + (periodos + 98)
                  .asInstanceOf[Char] + (_csc + 5) + ")",
                Some(2 + periodos),
                style = Some(CellStyle(dataFormat = CellDataFormat("#,##0"))),
                CellStyleInheritance.CellThenRowThenColumnThenSheet
              )
          ...
          for (x <- 1 to periodos) {
            cell1 = FormulaCell(
              "SUM(" + (x + 98).asInstanceOf[Char] + "5:" + (x + 98)
                .asInstanceOf[Char] + (_csc + 4) + ")",
              Some(1 + x),
              style = Some(CellStyle(dataFormat = CellDataFormat("#,##0"))),
              CellStyleInheritance.CellThenRowThenColumnThenSheet
            )
...
// LAS LUMINARIAS
          ...
          query = s"""SELECT * FROM public.crosstab(
          ...
          for (x <- 1 to periodos) {
            cell1 = FormulaCell(
              "SUM(" + (x + 98).asInstanceOf[Char] + (_csc0) + ":" + (x + 98)
                .asInstanceOf[Char] + (_csc + 4) + ")",
              Some(1 + x),
              style = Some(CellStyle(dataFormat = CellDataFormat("#,##0"))),
              CellStyleInheritance.CellThenRowThenColumnThenSheet
        ...
        rows = {
          ...
          var rows = resultSet.map {
            i =>
              ...
              _listCell += cell
              cell = StringCell(
                i.get(".cuad_descripcion") match {
                  case Some(v) => v.asInstanceOf[String]
                  case None    => "Sin Asignar"
                },
                Some(1),
                style = Some(CellStyle(dataFormat = CellDataFormat("@"))),
                CellStyleInheritance.CellThenRowThenColumnThenSheet
...
// LAS LUMINARIAS
    ...
    db.withConnection { implicit connection =>
      ...
      val sheet01 = Sheet(
        ...
        rows = {
          ...
          for (x <- 1 to periodos) {
            cell1 = FormulaCell(
              "SUM(" + (x + 99).asInstanceOf[Char] + "5:" + (x + 99)
                .asInstanceOf[Char] + (_csc + 4) + ")",
              Some(x + 2),
              style = Some(CellStyle(dataFormat = CellDataFormat("#,##0"))),
              CellStyleInheritance.CellThenRowThenColumnThenSheet
      ...
      val sheet01 = Sheet(
        ...
        rows = {
              ...
              if (_es_el_primero) {
                ...
                if (i._1 != aacu_descripcion_ant) {
                  ...
                  if ((_inicial_cuenta - 1) != _final_cuenta) {
                    _listMerged04 += CellRange(
                      (_inicial_cuenta - 1, _final_cuenta),
                      (0, 0)
                    )
                  }
          ...
          if (_inicial_cuenta != _final_cuenta) {
            _listMerged04 += CellRange(
              (_inicial_cuenta - 1, (_final_cuenta - 1)),
              (0, 0)
            )
          }
  ...
  def siap_informe_carga_aforo_xls(
    ...
    db.withConnection { implicit connection =>
                    ...
                    StringCell(
                      ...
                      style = Some(
                        CellStyle(
                          dataFormat = CellDataFormat("@"),
                          font = fuenteSubTotal,
                          fillPattern = CellFill.Pattern.BigSpots,
                          fillForegroundColor = colorSubTotal,
            ...
            StringCell(
              ...
              style = Some(
                CellStyle(
                  dataFormat = CellDataFormat("@"),
                  font = fuenteTotal,
                  fillForegroundColor = Color.Orange,
                  fillBackgroundColor = Color.White,
                  fillPattern = CellFill.Solid
                )
              ),
      ...
      val (sheet02, _lastMedidor) =
        siap_informe_carga_aforo_medidor_lectura_xls(fc, empr_id)
      val sheet03 = siap_informe_carga_aforo_resume_xls(
        fc,
        _listResumen,
        _lastMedidor,
        empr_id
  ...
  def siap_informe_carga_aforo_medidor_lectura_xls(
      fc: Calendar,
      empr_id: Long
  ): (Sheet, Long) = {
    var _listMerged04 = new ListBuffer[CellRange]()
                ...
                StringCell(
                  ...
                  style = Some(
                    CellStyle(
                      dataFormat = CellDataFormat("@"),
                      fillPattern = CellFill.Pattern.BigSpots,
                      fillForegroundColor = i._1 match {
                        case 0 => Color(254, 86, 72)
                        case _ => Color(255, 255, 255)
                      },
                      fillBackgroundColor = Color.White
                    )
                  ),
            ...
            StringCell(
              ...
              style = Some(
                CellStyle(
                  dataFormat = CellDataFormat("@"),
                  fillPattern = CellFill.Pattern.BigSpots,
                  fillForegroundColor = Color(255, 182, 108),
                  fillBackgroundColor = Color.White
                )
              ),
              CellStyleInheritance.CellThenRowThenColumnThenSheet
  ...
  def siap_informe_carga_aforo_resume_xls(
      fc: Calendar,
      _listResumen: ListBuffer[(String, Int)],
      _lastMedidor: Long,
      empr_id: Long
  ): Sheet = {
    var _listRow04 = new ListBuffer[com.norbitltd.spoiwo.model.Row]()
  ...
  def siap_reporte_foto(fecha_inicial: scala.Long, fecha_final: scala.Long, tireuc_id: scala.Long, reti_id: scala.Long, empr_id: scala.Long): (String, Array[Byte]) = {
    val fi = new DateTime(fecha_inicial)
    val ff = new DateTime(fecha_final)
    var os = Array[Byte]()
    val empresa = empresaService.buscarPorId(empr_id).get
