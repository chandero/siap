...
case class Siap_resumen_material(elem_codigo: Option[String], elem_descripcion: Option[String], even_cantidad_retirado: Option[Double], even_cantidad_instalado: Option[Double])
case class Siap_resumen_material_reporte(elem_codigo: Option[String], elem_descripcion: Option[String], reti_descripcion: Option[String], even_cantidad_retirado: Option[Double], even_cantidad_instalado: Option[Double])
case class Siap_detallado_material(elem_codigo: Option[String], elem_descripcion: Option[String], reti_descripcion: Option[String], repo_numero: Option[scala.Long], repo_fechasolucion: Option[DateTime], even_codigo_retirado: Option[String], even_cantidad_retirado: Option[Double], even_codigo_instalado: Option[String], even_cantidad_instalado: Option[Double] )
case class Siap_inventario_a(aap_id: Option[scala.Long],
...
case class Siap_inventario_b(tipo_descripcion: Option[String],
...
case class Inventario(aap_id: Option[scala.Long],
	                         aap_apoyo: Option[String],
	                         aap_direccion: Option[String],
	                         barr_descripcion: Option[String],
	                         tiba_descripcion: Option[String],
...
case class Siap_disponibilidad(repo_fecharecepcion: Option[String], repo_fechasolucion: Option[String], repo_consecutivo: Option[scala.Double], aap_id: Option[scala.Long], aap_potencia: Option[Int], vereda: Option[String], festivos: Option[Int])
case class Siap_eficiencia(repo_direccion: Option[String], barr_descripcion: Option[String], repo_consecutivo: Option[scala.Double], aap_id: Option[scala.Long], repo_fecharecepcion: Option[String], repo_fechasolucion: Option[String], festivos: Option[Int])
case class Siap_visita_por_barrio(barr_descripcion: Option[String], visitas: Option[Int])
case class Siap_material_repetido(even_codigo_instalado: String, reti_descripcion: String, repo_consecutivo: Int, repo_fechasolucion: DateTime, aap_id: scala.Long, aap_direccion: String, barr_descripcion: String, tiel_descripcion: String)
...
object Siap_visita_por_barrio {
    ...
    val _set = {
        ...
        get[Option[Int]]("visitas") map {
          case
            barr_descripcion ~
            visitas => new Siap_visita_por_barrio(barr_descripcion, visitas)
        }
    }
}
    ...
    val siap_disponibilidad_set = {
        ...
        get[Option[Int]]("festivos") map {
          case
             ...
             aap_potencia ~
             vereda ~
             festivos => new Siap_disponibilidad(repo_fecharecepcion, repo_fechasolucion, repo_consecutivo, aap_id, aap_potencia, vereda, festivos)
        }
    }
}
    ...
    val _set = {
        ...
        get[Option[Int]]("festivos") map {
          case
             ...
             repo_fecharecepcion ~
             repo_fechasolucion ~ 
             festivos => new Siap_eficiencia(repo_direccion, barr_descripcion, repo_consecutivo, aap_id, repo_fecharecepcion, repo_fechasolucion, festivos)
        }
    }
}
...
object Siap_material_repetido {
    ...
    val _set = { 
        ...
        get[String]("tiel_descripcion") map { case a ~ b ~ c ~ d ~ e ~ f ~ g ~ h => new Siap_material_repetido(a, b, c, d, e, f, g, h) }
    }
}

case class Siap_detallado_expansion(repo_fechasolucion: Option[DateTime], 
...
case class Siap_detallado_reubicacion(repo_fechasolucion: Option[DateTime], 
                                    repo_fechadigitacion: Option[DateTime], 
                                    aap_rte: Option[String],
                                    aap_id: Option[scala.Long], 
...
case class Siap_detallado_modernizacion(repo_fecharecepcion: Option[DateTime],
...
case class Siap_detallado_actualizacion(repo_fecharecepcion: Option[DateTime],
                                        repo_fechasolucion: Option[DateTime],
                                        aap_rte: Option[String],
                                        aap_id: Option[scala.Long],
                                        aap_direccion: Option[String],
...
case class Siap_detallado_reposicion(repo_fecharecepcion: Option[DateTime],
                                        repo_fechasolucion: Option[DateTime],
                                        aap_rte: Option[String],
                                        aap_id: Option[scala.Long],
                                        aap_direccion: Option[String],
...
case class Siap_detallado_repotenciacion(repo_fecharecepcion: Option[DateTime],
                                        repo_fechasolucion: Option[DateTime],
                                        aap_rte: Option[String],
                                        aap_id: Option[scala.Long],
                                        aap_direccion: Option[String],
...
case class Siap_detallado_retiro(repo_fecharecepcion: Option[DateTime],
                                        repo_fechasolucion: Option[DateTime],
...
case class Siap_retiro_reubicacion_a(repo_fecharecepcion: Option[DateTime],
                                    repo_fechasolucion: Option[DateTime],
                                    repo_fechadigitacion: Option[DateTime],
                                    repo_consecutivo: Option[Int],
                                    aap_id: Option[scala.Long],
...
case class Siap_retiro_reubicacion_b(repo_fecharecepcion: Option[DateTime], 
                                    repo_fechasolucion: Option[DateTime], 
                                    repo_fechadigitacion: Option[DateTime],
                                    aap_rte: Option[String],
                                    aap_id: Option[scala.Long], 
...
case class Siap_retiro_reubicacion( retiro: Option[Siap_retiro_reubicacion_a], reubicacion: Option[Siap_retiro_reubicacion_b])

case class Siap_consolidado(repo_consecutivo: Option[Int],
    ...
    val set = {
        ...
        get[Option[String]]("repo_reportetecnico") map {
            case 
                 ...
                 repo_descripcion ~                 
                 repo_fechasolucion ~
                 repo_reportetecnico => new Siap_consolidado(
                                                            repo_consecutivo,
                                                            repo_fecharecepcion,
                                                            repo_nombre,
                                                            repo_telefono,
    ...
    val siap_detallado_expansion_set = {
        ...
        get[Option[String]]("urba_descripcion") map {
            case 
                 ...
                 aap_tecnologia ~ 
                 aaco_descripcion ~
                 urba_descripcion => new Siap_detallado_expansion(
                                                                 repo_fechasolucion,
                                                                 repo_fechadigitacion,
                                                                 aap_rte,
                                                                 aap_id,
    ...
    val siap_detallado_reubicacion_set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                 ...
                 aaus_descripcion ~
                 aacu_descripcion ~
                 aaco_descripcion => new Siap_detallado_reubicacion(
                                                                 repo_fechasolucion,
                                                                 repo_fechadigitacion,
                                                                 aap_rte,
                                                                 aap_id,
    ...
    val siap_detallado_modernizacion_set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                ...
                aap_potencia ~
                aap_tecnologia ~
                aaco_descripcion => new Siap_detallado_modernizacion(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    aap_rte,
                    aap_id,
    ...
    val siap_detallado_actualizacion_set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                ...
                aap_potencia ~
                aap_tecnologia ~
                aaco_descripcion => new Siap_detallado_actualizacion(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    aap_rte,
                    aap_id,
    ...
    val siap_detallado_reposicion_set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                ...
                aap_potencia ~
                aap_tecnologia ~
                aaco_descripcion => new Siap_detallado_reposicion(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    aap_rte,
                    aap_id,
    ...
    val siap_detallado_repotenciacion_set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                ...
                aap_potencia ~
                aap_tecnologia ~
                aaco_descripcion => new Siap_detallado_repotenciacion(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    aap_rte,
                    aap_id,
    ...
    val set = {
        ...
        get[Option[String]]("tire_descripcion") map {
            case 
                ...
                aaco_descripcion ~
                reubicado ~
                tire_descripcion => new Siap_detallado_retiro(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    repo_consecutivo,
                    aap_id,
...
object Siap_retiro_reubicacion_a {
    ...
    implicit val yourJodaDateWrites = JodaWrites.jodaDateWrites("yyyy/MM/dd HH:mm")
    ...
    val set = {
        ...
        get[Option[String]]("enbaja") map {
            case 
                ...
                aap_tecnologia ~
                aaco_descripcion ~
                enbaja => new Siap_retiro_reubicacion_a(
                    repo_fecharecepcion,
                    repo_fechasolucion,
                    repo_fechadigitacion,
                    repo_consecutivo,
    ...
    val set = {
        ...
        get[Option[String]]("aaco_descripcion") map {
            case 
                 ...
                 aap_potencia ~ 
                 aap_tecnologia ~  
                 aaco_descripcion => new Siap_retiro_reubicacion_b(
                                                                 repo_fecharecepcion,
                                                                 repo_fechasolucion,
                                                                 repo_fechadigitacion,
                                                                 aap_rte,
...
class InformeRepository @Inject()(dbapi: DBApi, usuarioService: UsuarioRepository, empresaService: EmpresaRepository, municipioService: MunicipioRepository)(implicit ec:DatabaseExecutionContext) {
    ...
    private val siap_resumen_material_set = {
        ...
        get[Option[Double]]("even_cantidad_instalado") map {
            case 
                 ...
                 even_cantidad_instalado => new Siap_resumen_material(elem_codigo, 
                                                                      elem_descripcion,
                                                                      even_cantidad_retirado,
    ...
    private val siap_resumen_material_reporte_set = {
        ...
        get[Option[Double]]("even_cantidad_instalado") map {
            case 
                 ...
                 reti_descripcion ~
                 even_cantidad_retirado ~ 
                 even_cantidad_instalado => new Siap_resumen_material_reporte(elem_codigo, 
                                                                      elem_descripcion,
                                                                      reti_descripcion,
                                                                      even_cantidad_retirado,
                                                                      even_cantidad_instalado)
    ...
    private val siap_detallado_material_set = {
        ...
        get[Option[Double]]("even_cantidad_instalado") map {
            case 
                 ...
                 even_cantidad_retirado ~ 
                 even_codigo_instalado ~
                 even_cantidad_instalado => new Siap_detallado_material(elem_codigo, 
                                                                      elem_descripcion,
                                                                      reti_descripcion,
                                                                      repo_consecutivo,
                                                                      repo_fechasolucion,
    ...
    def siap_visita_por_barrio_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long):  Future[Iterable[Siap_visita_por_barrio]] = Future[Iterable[Siap_visita_por_barrio]]{
    ...
    */
    def siap_resumen_material_reporte_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_resumen_material_reporte]] = Future[Iterable[Siap_resumen_material_reporte]]{
            db.withConnection { implicit connection =>
...
ORDER BY e.reti_id, e.elem_codigo""").on(
                                'fecha_inicial -> fi.getTime(),
                                'fecha_final -> ff.getTime(),
                                'empr_id -> empr_id
    ...
    * resumen material reporte
    */
    def siap_resumen_material_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long):Future[Iterable[Siap_resumen_material]] = Future[Iterable[Siap_resumen_material]]{
        db.withConnection { implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * resumen material reporte
    */
    def siap_detallado_material_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long):Future[Iterable[Siap_detallado_material]] = Future[Iterable[Siap_detallado_material]]{
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
            ...
            SQL("""SELECT e.elem_codigo, e.elem_descripcion, p.reti_descripcion, 
                    ...
                    INNER JOIN siap.elemento e on e.elem_id = t.elem_id
                    WHERE r.obra_fechasolucion BETWEEN {fecha_inicial} and {fecha_final} and r.rees_id <> 9 and t.even_estado <> 9 and r.empr_id = {empr_id}
                    ORDER BY reti_descripcion, elem_codigo""").on(
                                'fecha_inicial -> fi.getTime(),
                                'fecha_final -> ff.getTime(),
                                'empr_id -> empr_id
    ...
    * @return OutputStream
    */
    def siap_detallado_material(fecha_inicial: scala.Long, fecha_final: scala.Long, usua_id: scala.Long, empr_id: scala.Long): Array[Byte] = {
    ...
    * @return OutputStream
    */
    def siap_resumen_material_reporte(fecha_inicial: scala.Long, fecha_final: scala.Long, usua_id: scala.Long, empr_id: scala.Long): Array[Byte] = {
            val empresa = empresaService.buscarPorId(empr_id).get
            val usuario = usuarioService.buscarPorId(usua_id).get
            db.withConnection { connection =>
            var os = Array[Byte]()
    ...
    * @return OutputStream
    */
    def siap_resumen_material(fecha_inicial: scala.Long, fecha_final: scala.Long, usua_id: scala.Long, empr_id: scala.Long): Array[Byte] = {
            val empresa = empresaService.buscarPorId(empr_id).get
            val usuario = usuarioService.buscarPorId(usua_id).get
            db.withConnection { connection =>
            var os = Array[Byte]()
    ...
    * @return OutputStream
    */
    def siap_reporte_por_uso_xls(fecha_toma: scala.Long, usua_id: scala.Long, empr_id: scala.Long): Array[Byte] = {
        val empresa = empresaService.buscarPorId(empr_id).get
        val usuario = usuarioService.buscarPorId(usua_id).get
        db.withConnection { connection =>
        //var os = Array[Byte]()
        ...
        val reportParams = new HashMap[String, java.lang.Object]()
            ...
            reportParams.put("EMPRESA", empresa.empr_descripcion)
            reportParams.put("USUARIO", usuario.usua_nombre + " " + usuario.usua_apellido)        
        var jasperPrint = JasperFillManager.fillReport(compiledFile, reportParams, connection)
    ...
    def siap_inventario_total(fecha_corte: scala.Long, empr_id: scala.Long) : scala.Long = {
        db.withConnection { implicit connection =>
    ...
    def siap_inventario(fecha_corte: scala.Long, empr_id: scala.Long, page_size: scala.Long, current_page: scala.Long): Future[Iterable[Siap_inventario]] = Future[Iterable[Siap_inventario]] { 
        var _list = new ListBuffer[Siap_inventario]()
        db.withConnection { implicit connection =>
            var resultSet = SQL("""SELECT
	                        a.aap_id,
	                        a.aap_apoyo,
	                        a.aap_direccion,
	                        b.barr_descripcion,
    ...
    def siap_inventario_xls(fecha_corte: Long, empr_id: Long): Array[Byte] = { 
        db.withConnection { implicit connection =>
            ...
            val sheet = Sheet(name="Inventario" + fmt.print(dt),
                rows = { 
                    ...
                    val rows = resultSet.map { i => 
                                                    com.norbitltd.spoiwo.model.Row().withCellValues(
                                                                        i.aap_id match { case Some(value) => value case None => "" },
                                                                        i.aap_apoyo match { case Some(value) => value case None => "" },
	                                                                    i.aap_direccion match { case Some(value) => value case None => "" },
	                                                                    i.barr_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.tiba_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aaus_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aap_modernizada match { case Some(value) => value case None => "" },
	                                                                    i.aap_modernizada_anho match { case Some(value) => value case None => "" },
	                                                                    i.aatc_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aap_medidor match { case Some(value) => value case None => "" },
	                                                                    i.aaco_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aama_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aamo_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aacu_descripcion match { case Some(value) => value case None => "" },
                                                                        i.tipo_descripcion match { case Some(value) => value case None => "" },
	                                                                    i.aap_poste_altura match { case Some(value) => value case None => "" },
	                                                                    i.aap_poste_propietario match { case Some(value) => value case None => "" },
	                                                                    i.aap_brazo match { case Some(value) => value case None => "" },
	                                                                    i.aap_collarin match { case Some(value) => value case None => "" },
	                                                                    i.aap_potencia match { case Some(value) => value case None => "" },
	                                                                    i.aap_tecnologia match { case Some(value) => value case None => "" },
	                                                                    i.aap_rte match { case Some(value) => value case None => "" },
	                                                                    i.aap_bombillo match { case Some(value) => value case None => "" },
	                                                                    i.aap_balasto match { case Some(value) => value case None => "" },
	                                                                    i.aap_arrancador match { case Some(value) => value case None => "" },
	                                                                    i.aap_condensador match { case Some(value) => value case None => "" },
	                                                                    i.aap_fotocelda match { case Some(value) => value case None => "" }
                                                                       )}
    ...
    def siap_inventario_filtro_xls(fecha_corte: Long, empr_id: Long, orderby:String, filter:String): Array[Byte] = { 
        db.withConnection { implicit connection =>
            val dt = new DateTime(fecha_corte)
            val fmt = DateTimeFormat.forPattern("yyyyMMdd")
            val sheet = Sheet(name="Inventario" + fmt.print(dt),
    ...
    * @return OutputStream
    */
    def siap_detallado_expansion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_expansion]] = Future[Iterable[Siap_detallado_expansion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
            ...
            SQL("""select distinct r.repo_fechasolucion, r.repo_fechasolucion as repo_fechadigitacion, r.repo_consecutivo::text as aap_rte, a.aap_id, a.aap_direccion, b.barr_descripcion, case when b.tiba_id = 2 then 'X' else '' end as vereda, case when b.tiba_id = 5 then 'X' else '' end as parque, au.aaus_descripcion, ac.aacu_descripcion, r.repo_descripcion, tp.tipo_descripcion, case when tp.tipo_id = 1 then 'X' else '' end as concreto, case when tp.tipo_id = 2 then 'X'  else '' end as metalico, mo.aamo_descripcion, d.aap_potencia, d.aap_tecnologia, co.aaco_descripcion, case when co.aaco_id = 2 then 'X' else '' end as medidor, case when co.aaco_id = 1 then 'X' else ' ' end as aforo, u.urba_descripcion from siap.reporte r 
                    ...
                    order by r.repo_fechasolucion, r.repo_descripcion, a.aap_id""").on(
                    'fecha_inicial -> fi.getTime(),
                    'fecha_final -> ff.getTime(),
                    'empr_id -> empr_id
    ...
    * @return OutputStream
    */
    def siap_detallado_reubicacion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_reubicacion]] = Future[Iterable[Siap_detallado_reubicacion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_detallado_modernizacion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_modernizacion]] = Future[Iterable[Siap_detallado_modernizacion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_detallado_actualizacion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_actualizacion]] = Future[Iterable[Siap_detallado_actualizacion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_detallado_reposicion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_reposicion]] = Future[Iterable[Siap_detallado_reposicion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_detallado_repotenciacion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_reposicion]] = Future[Iterable[Siap_detallado_reposicion]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_detallado_retiro_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_detallado_retiro]] = Future[Iterable[Siap_detallado_retiro]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    def siap_detallado_retiro_reubicacion_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_retiro_reubicacion]] = Future[Iterable[Siap_retiro_reubicacion]] {
        ...
        db.withConnection {  implicit connection =>
            ...
            ff.set(Calendar.MINUTE, 59)
            ff.set(Calendar.HOUR, 23)        
            val retiros = SQL("""SELECT distinct r.repo_fecharecepcion, 
                    r.repo_fechasolucion,
            ...
            retiros.map { retiro =>
                val reubicacion = SQL("""select r.repo_fecharecepcion,
                                            r.repo_fechasolucion,
                                            ra.repo_modificado as repo_fechadigitacion,
                                            r.repo_consecutivo::text as aap_rte,
                                            a.aap_id, 
                ...
                val retiro_reubicacion = new Siap_retiro_reubicacion(Some(retiro), reubicacion)
                _listData += retiro_reubicacion
            }

            val reubicaciones = SQL("""select r.repo_fecharecepcion,
                                            r.repo_fechasolucion,
                                            ra.repo_modificado as repo_fechadigitacion,
                                            r.repo_consecutivo::text as aap_rte,
                                            a.aap_id, 
            ...
            reubicaciones.map { reubicacion => 
                val retiro = SQL("""SELECT r.repo_fecharecepcion, 
                    r.repo_fechasolucion,
                    ra.repo_modificado as repo_fechadigitacion,
                    r.repo_consecutivo,
                    a.aap_id, 
                ...
                var ret = new Siap_retiro_reubicacion_a(None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None)
                retiro match {
                    case Some(r) => ret = r
                    case None => None
                }
                val retiro_reubicacion = new Siap_retiro_reubicacion(Some(ret), Some(reubicacion))
                 _listData += retiro_reubicacion
            }
    ...
    * @return OutputStream
    */
    def siap_disponibilidad_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, wt:Double, empr_id: scala.Long): Array[Byte] = {
        import Height._
        db.withConnection {  implicit connection =>
          ...
          empresa match {
           ...
           val municipio = municipioService.buscarPorId(empresa.muni_id)
            ...
            val resultSet = SQL("""select distinct 
                           ...
                           order by r.repo_fechasolucion::text asc""").on(
                    'fecha_inicial -> fi,
                    'fecha_final -> ff,
                    'empr_id -> empr_id
                    ).as(Siap_disponibilidad.siap_disponibilidad_set *)

            val sheet1 = Sheet(name="HojaT",
                rows = {
                    val titleRow = com.norbitltd.spoiwo.model.Row().withCellValues(empresa.empr_descripcion)
                    val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Fecha Del Reporte", "Fecha de Ejecución", "Reporte","Código de Luminaria", "Potencia", "HSSi", "Tope Horas Apagada", "Días", "Vereda", "Fecha Solución Vereda", "Días Dif", "Horas Dif")
                    var j = 2
                    val rows = resultSet.map { i => j+=1
                                                    com.norbitltd.spoiwo.model.Row(
                                                        DateCell(i.repo_fecharecepcion match { case Some(value) => format.parse(value) },Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("YYYY-MM-DD"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        DateCell(i.vereda match { case Some(v) => i.repo_fecharecepcion match { case Some(value) => format.parse(value) } case None => i.repo_fechasolucion match { case Some(value) => format.parse(value) }},Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("YYYY-MM-DD"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(i.repo_consecutivo.get,Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(i.aap_id match { case Some(value) => value },Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(i.aap_potencia match { case Some(value) => value },Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(A"+j+"=B"+j+",12,(B"+j+"-A"+j+")*12)",Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(F"+j+">=48,F"+j+",0)",Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(F"+j+">=48,B"+j+"-A"+j+")",Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        StringCell(i.vereda match { case Some(value) => "X" case None => ""}, Some(8),  style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        StringCell(i.vereda match { case Some(value) => i.repo_fechasolucion match { case Some(value) => value } case None => ""}, Some(9), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(I"+j+"=\"X\","+"J"+j+"-A"+j+",\"\")", Some(10), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(I"+j+"=\"X\","+"(J"+j+"-A"+j+")*12,\"\")", Some(11), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        )                                                        
                                                    )
                                             }
            ...
            val sheet2 = Sheet(name="HojaC",
                rows = { 
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("INTERVENTORIA ALUMBRADO PUBLICO", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("MUNICIPIO " + municipio.get.muni_descripcion, index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("MANUAL DE PROCEDIMIENTOS", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("INDICE DE DISPONIBILIDAD DE LUMINARIAS DEL SALP", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("ACTA ITAF No.", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("CORRESPONDIENTE AL MES DE ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("En el Municipio SAN JUAN GIRON, se reunieron los Ingenieros GABRIEL EMILIO MARTINEZ MARTINEZ, Director Técnico E Ing Residente ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("de la Concesionaria ISAG S.A. y SALOMON IGLESIAS IGLESIAS  en su calidad Director Técnico de la firma ITAF  S.A.S., Interventora ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("del contrato de Concesión No. 094 con el fin de calcular el Índice de disponibilidad del sistema de alumbrado público del municipio ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell(municipio.get.muni_descripcion + ", aplicando la Resolución 123 de la CREG.", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("Índice de disponibilidad: Es el tiempo total sobre un periodo dado, durante el cual un activo del Sistema de Alumbrado ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("Público está disponible para el servicio y se mide a través de las interrupciones por luminarias que no funcionan o funcionan ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row(StringCell("de manera deficiente, reportadas por los usuarios y el interventor al SIAP, se calcula de acuerdo con la siguiente expresión: ", index = Some(0), style = Some(CellStyle(horizontalAlignment = HA.Center, font = Font(height = 11.points, fontName = "Arial Narrow"))), CellStyleInheritance.CellThenRowThenColumnThenSheet))
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")   
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("ID", Some(0), style = Some(CellStyle(font = Font(bold = true), horizontalAlignment = HA.Center, verticalAlignment = VA.Top)), CellStyleInheritance.CellThenRowThenColumnThenSheet ),
                        StringCell("Índice de disponibilidad de la infraestructura, para el período de remuneración.", Some(1), style = Some(CellStyle(font = Font(bold = false))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                    )                 
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("Wi", Some(0), style = Some(CellStyle(font = Font(bold = true), horizontalAlignment = HA.Center, verticalAlignment = VA.Top)), CellStyleInheritance.CellThenRowThenColumnThenSheet ),
                        StringCell("Potencia de la luminaria i en kW , reportada al registro de quejas y reclamos de alumbrado público. ", Some(1), style = Some(CellStyle(font = Font(bold = false))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                    )      
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("HSSi", Some(0), style = Some(CellStyle(font = Font(bold = true), horizontalAlignment = HA.Center, verticalAlignment = VA.Top)), CellStyleInheritance.CellThenRowThenColumnThenSheet ),
                        StringCell("Número total de horas sin servicio de la luminaria i.", Some(1), style = Some(CellStyle(font = Font(bold = false))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                    )              
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("WT", Some(0), style = Some(CellStyle(font = Font(bold = true), horizontalAlignment = HA.Center, verticalAlignment = VA.Top)), CellStyleInheritance.CellThenRowThenColumnThenSheet ),
                        StringCell("Potencia total instalada en kW de las luminarias que componen el  Sistema de Alumbrado Público.", Some(1), style = Some(CellStyle(font = Font(bold = false))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                    )                                 
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("T", Some(0), style = Some(CellStyle(font = Font(bold = true), horizontalAlignment = HA.Center, verticalAlignment = VA.Top)), CellStyleInheritance.CellThenRowThenColumnThenSheet ),
                        StringCell("Número de horas del  período de facturación de las luminarias.", Some(1), style = Some(CellStyle(font = Font(bold = false))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                    ) 
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")   
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")   
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("")
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("PERIODO")   
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("","","Wi","","HSSI", "WT", "T", "ID")
                    _listRow += com.norbitltd.spoiwo.model.Row().withCellValues("m","","W","KW","","", dias.get)
                    var j = 27
                    var rows = resultSet.map { i => j+=1
                                                    _listRow += com.norbitltd.spoiwo.model.Row(
                                                        NumericCell(j-27, Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                                        StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                                        FormulaCell("+HojaT!$E"+(j-25),Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("+C"+(j)+"/1000",Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("0.0000"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("+HojaT!$F"+(j-25),Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(wt,Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("$G$27*12",Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("(D"+j+"*E"+j+")/(F"+j+"*G"+j+")",Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("0.0000%"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        )                                                        
                                                    )
                                             }

                    _listRow += com.norbitltd.spoiwo.model.Row(
                                StringCell("INDICE DE DISPONIBILIDAD", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),                                
                                StringCell("", Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                StringCell("", Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                StringCell("", Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                StringCell("", Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet),
                                FormulaCell("1-SUM(H28:H"+j+")",Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("00.00%"))), CellStyleInheritance.CellThenRowThenColumnThenSheet)
                        )
                ...
                columns = {
                     _listColumn += com.norbitltd.spoiwo.model.Column(index = 7, width = new Width(40, WidthUnit.Character))
                     _listColumn.toList
                }
            )
    ...
    * @return OutputStream
    */
    def siap_graficos_reporte(fecha_inicial: scala.Long, fecha_final: scala.Long, usua_id: scala.Long, empr_id: scala.Long, num_id: Int): Array[Byte] = {
            val empresa = empresaService.buscarPorId(empr_id).get
            ...
            var compiledFile = ""
            num_id match {
                case 1 => compiledFile = REPORT_DEFINITION_PATH + "siap_oym_recibidas.jasper"
                case 2 => compiledFile = REPORT_DEFINITION_PATH + "siap_oym_uso_recibidas.jasper"
                case 3 => compiledFile = REPORT_DEFINITION_PATH + "siap_oym_atendidos.jasper"
                case 4 => compiledFile = REPORT_DEFINITION_PATH + "siap_oym_recibidas_vs_pendientes.jasper"
                case 5 => compiledFile = REPORT_DEFINITION_PATH + "siap_oym_sector_recibidas.jasper"
            }
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
    ...
    * @return OutputStream
    */
    def siap_reporte_consolidado_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Future[Iterable[Siap_consolidado]] = Future[Iterable[Siap_consolidado]] {
        db.withConnection {  implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
            ...
            SQL("""select distinct 
                   ...
                   from siap.reporte r 
                    ...
                    order by r.repo_fecharecepcion, r.repo_consecutivo""").on(
                    'fecha_inicial -> fi.getTime(),
                    'fecha_final -> ff.getTime(),
                    'empr_id -> empr_id
    ...
    def siap_material_repetido_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, tiel_id: scala.Long, empr_id: scala.Long) = Future[Iterable[Siap_material_repetido]] {
        db.withConnection { implicit connection =>
            var fi = Calendar.getInstance()
            var ff = Calendar.getInstance()
            fi.setTimeInMillis(fecha_inicial)
            ...
            val repetidas = SQL("""select distinct re.even_codigo_instalado, rt.reti_descripcion, r.repo_consecutivo, r.repo_fechasolucion, re.aap_id, a.aap_direccion, b.barr_descripcion, te.tiel_descripcion from siap.reporte r
    ...
    * @return OutputStream
    */
    def siap_eficiencia_xls(fecha_inicial: scala.Long, fecha_final: scala.Long, empr_id: scala.Long): Array[Byte] = {
        import Height._
        db.withConnection {  implicit connection =>
          val empresa = empresaService.buscarPorId(empr_id)
          empresa match {
           ...
           val municipio = municipioService.buscarPorId(empresa.muni_id)
            ...
            var _listColumn = new ListBuffer[com.norbitltd.spoiwo.model.Column]()
            var _listMerged = new ListBuffer[CellRange]()
            var conteo = SQL("""SELECT COUNT(o) FROM (select distinct 
                                    r.repo_direccion,
                                    b.barr_descripcion,
                                    r.repo_consecutivo,
                                    e.aap_id,
            ...
            val resultSet = SQL("""select distinct 
                                   ...
                                   order by r.repo_fecharecepcion::text, r.repo_consecutivo, e.aap_id""").on(
                    'fecha_inicial -> fi,
                    'fecha_final -> ff,
                    'empr_id -> empr_id
            ...
            val sheet1 = Sheet(name="HojaT",
                rows = {
                    val titleRow = com.norbitltd.spoiwo.model.Row().withCellValues(empresa.empr_descripcion)
                    val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Consecutivo", "Dirección", "Barrio", "Reporte", "Código Luminaria", "Fecha De Recepción", "Fecha de Solución", "Días Solución", "ei")
                    var j = 2
                    val conteo2 = conteo + 6
                    val rows = {
                                        resultSet.map { i => j+=1
                                                    _listRow += com.norbitltd.spoiwo.model.Row(
                                                        NumericCell(j-2, Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        StringCell(i.repo_direccion match { case Some(d) => d case None => ""}, Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        StringCell(i.barr_descripcion match { case Some(b) => b case None => ""}, Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(i.repo_consecutivo.get,Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        NumericCell(i.aap_id match { case Some(value) => value },Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        DateCell(i.repo_fecharecepcion match { case Some(value) => format.parse(value) },Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("YYYY-MM-DD"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        DateCell(i.repo_fechasolucion match { case Some(value) => format.parse(value) },Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("YYYY-MM-DD"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("G"+j+"-F"+j,Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        ),
                                                        FormulaCell("IF(H"+j+"<$D$"+ conteo2+",1,$D"+conteo2+"/H"+j+")",Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("0.00%"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                        )
                                                    )
                                             }
                                        _listRow += com.norbitltd.spoiwo.model.Row(
                                            StringCell("", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ...
                                            StringCell("", Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            FormulaCell("SUM(I3:I"+(j)+")/D"+ (conteo2-1),Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("0.00%"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            )
                                        )
                                        _listRow += com.norbitltd.spoiwo.model.Row(
                                            StringCell("", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ...
                                            StringCell("", Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                        )  
                                        _listRow += com.norbitltd.spoiwo.model.Row(
                                            StringCell("Número de Reportes", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            NumericCell(conteo, Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                        ...
                                        _listRow += com.norbitltd.spoiwo.model.Row(
                                            StringCell("Patrón de Operación (p)", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            NumericCell(3, Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                            ),
                                            StringCell("", Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
    ...
    * @return OutputStream
    */
    def siap_calculo_carga_xls(periodo: scala.Long, anho: scala.Long, empr_id: scala.Long): Array[Byte] = {
        import Height._
        db.withConnection {  implicit connection =>
          val empresa = empresaService.buscarPorId(empr_id)
          var electrificadora = SQL("""SELECT g.gene_valor FROM siap.general g WHERE g.gene_id = {gene_id}""").
          ...
          empresa match {
           case Some(empresa) =>
            ...
            val _cuentaParser = str("aacu_descripcion") ~ int("aacu_id") map { case n ~ p => (n, p) }
            val _aapParser = get[Option[String]]("aap_tecnologia") ~ get[Option[Int]]("aap_potencia") ~ get[Option[Double]]("aap_potenciareal") ~ get[Option[Int]]("cantidad") ~ get[Option[Int]]("retirada") ~ get[Option[Int]]("instalada")map { case t ~ p ~ r ~ c ~ e ~ i=> (t,p,r,c,e,i)}
            println("Leyento Cuentas Alumbrado")
            val _rcuentas: List[(String, Int)] = SQL("""SELECT aacu_id, aacu_descripcion FROM siap.aap_cuentaap WHERE empr_id = {empr_id} AND aacu_estado = 1 ORDER BY aacu_orden""").
            on('empr_id -> empr_id).as(_cuentaParser.*)

            val sqlInsert = """INSERT INTO siap.carga (empr_id, zanho, zperiodo, aaco_id, aacu_id, aap_tecnologia, aap_potencia, cantidad, retirada, instalada)
                               VALUES({empr_id}, {zanho}, {zperiodo}, {aaco_id}, {aacu_id}, {aap_tecnologia}, {aap_potencia}, {cantidad}, {retirada}, {instalada})"""

            val sqlUpdate = """UPDATE siap.carga SET retirada = retirada + {retirada}, instalada = instalada + {instalada} 
            ...
            /// Carga Inicial Tabla
            val _cargaInicialParser = int("aaco_id") ~ int("aacu_id") ~ str("aap_tecnologia") ~ int("aap_potencia") ~ int("cantidad") map { case a ~ b ~ c ~ d ~ e => (a,b,c,d,e) }
            println("Leyendo carga Inicial")
            val _rcargaInicial = SQL("""SELECT a.aaco_id, a.aacu_id, ad.aap_tecnologia, ad.aap_potencia, COUNT(a) AS cantidad FROM siap.aap a
            INNER JOIN siap.aap_adicional ad ON ad.aap_id = a.aap_id
            ...
            ORDER BY a.aaco_id, a.aacu_id, ad.aap_tecnologia DESC, ad.aap_potencia""").on(
                'empr_id -> empr_id,
                'fecha_toma -> ft
            ...
            SQL("""DELETE FROM siap.carga WHERE empr_id = {empr_id} and zanho = {zanho} and zperiodo = {zperiodo}""").on(
                'empr_id -> empr_id,
                'zanho -> anho,
                'zperiodo -> periodo
            ).execute()
            ...
            _rcargaInicial.map ( r => 
                SQL("""INSERT INTO siap.carga (empr_id, zanho, zperiodo, aaco_id, aacu_id, aap_tecnologia, aap_potencia, cantidad, retirada, instalada) 
                        VALUES ({empr_id}, {zanho}, {zperiodo}, {aaco_id}, {aacu_id}, {aap_tecnologia}, {aap_potencia}, {cantidad}, {retirada}, {instalada})""").on(
                            'empr_id -> empr_id,
                            'zanho -> anho,
                            'zperiodo -> periodo,
                            'aaco_id -> r._1,
            ...
            val _dataParser = int("aaco_id") ~ int("aacu_id") ~ str("aap_tecnologia") ~ int("aap_potencia") ~ int("count") map { case a ~ b ~ c ~ d ~ e => (a,b,c,d,e) }
            ...
            val _rdataAnterior = SQL("""SELECT c.aaco_id, c.aacu_id, c.aap_tecnologia, c.aap_potencia, (cantidad - retirada + instalada) as count
                                        FROM siap.carga c
            ...
            _rdataAnterior.map { r =>
                SQL("""UPDATE siap.carga SET cantidad = {cantidad}
                       WHERE empr_id = {empr_id} and zanho = {zanho} and zperiodo = {zperiodo} and
                             aaco_id = {aaco_id} and aacu_id = {aacu_id} and aap_tecnologia = {aap_tecnologia} and aap_potencia = {aap_potencia}""")
                    .on(
                        'aaco_id -> r._1,
            ...
            val _rcargaPorExpansion = SQL(_qcargaPorExpansion).on(
                'fecha_inicial -> fi,
                'fecha_final -> ff,
                'fecha_toma -> ft,
                'empr_id -> empr_id
            ...
            ORDER BY o.aaco_id, o.aacu_id, o.aap_tecnologia, o.aap_potencia"""
                ...
                val _rcargaPorReubicacion = SQL(_qcargaPorReubicacion).on(
                    'fecha_inicial -> fi,
                    'fecha_final -> ff,
                    'fecha_toma -> ft,
                    'empr_id -> empr_id
            ...
            ORDER BY o.aaco_id, o.aacu_id, o.aap_tecnologia, o.aap_potencia"""
                ...
                val _rcargaPorRepotenciacion = SQL(_qcargaPorRepotenciacion).on(
                    'fecha_inicial -> fi,
                    'fecha_final -> ff,
                    'fecha_toma -> ft,
                    'empr_id -> empr_id
            ...
            ORDER BY o.aaco_id, o.aacu_id, o.aap_tecnologia, o.aap_potencia"""
                ...
                val _rcargaPorActualizacion = SQL(_qcargaPorActualizacion).on(
                    'fecha_inicial -> fi,
                    'fecha_final -> ff,
                    'fecha_toma -> ft,
                    'empr_id -> empr_id
            ...
            val _rcargaPorModernizacion = SQL(_qcargaPorModernizacion).on(
                'fecha_inicial -> fi,
                'fecha_final -> ff,
                'fecha_toma -> ft,
                'empr_id -> empr_id
            ...
            val _rcargaPorReposicion = SQL(_qcargaPorReposicion).on(
                'fecha_inicial -> fi,
                'fecha_final -> ff,
                'fecha_toma -> ft,
                'empr_id -> empr_id
            ...
            val _rcargarPorRetiro = SQL(_qcargarPorRetiro).on(
                'fecha_inicial -> fi,
                'fecha_final -> ff,
                'fecha_toma -> ft,
                'empr_id -> empr_id
            ...
            val titleRow1 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true), horizontalAlignment = HA.Center)).withCellValues(electrificadora)
            val titleRow2 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true), horizontalAlignment = HA.Center)).withCellValues("RESUMEN CARGA INSTALADA " + empresa.empr_descripcion)
            val titleRow3 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true), horizontalAlignment = HA.Center)).withCellValues("SEGUN INVENTARIO VERIFICADO Y ACEPTADO POR LAS PARTES")
            val headerRow1 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true, height = 8.points, fontName = "Arial"), horizontalAlignment = HA.Center)).withCellValues("Tipo","Potencia", "Potencia", "Datos " + mes + " " + anho, "", "Novedades", "", "", "Datos Finales Energía Calculada Según RES CREG 123/2011 Art. 12","","","","","","","TARIFA","Valor Energía","DESCUENTO","Valor Energía")
            val headerRow2 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true, height = 8.points, fontName = "Arial"), horizontalAlignment = HA.Center)).withCellValues("de","Nominal", "Real", "Cantidad", "Potencia", "Retiradas", "Instaladas", "Balance", "Cantidad", "Potencia", "Qn", "Tn", "DPFn", "CEEn","","$/Kwh","Mes/$","Mes/$","Mes/$")
            val headerRow3 = com.norbitltd.spoiwo.model.Row(style= CellStyle(font = Font(bold=true, height = 10.points, fontName = "Arial"), horizontalAlignment = HA.Center)).withCellValues("Luminaria","[w]", "(w)", "Cantidad", "Potencia", "Retiradas", "Instaladas", "Balance", "[u]", "[w]", "[Kw]", "", "", "Kwh","","","BRUTA",0.03,"NETA")
            ...
            var filas = {
                    _rcuentas.map { cuenta =>
                        ...
                        val _raaps = SQL("""SELECT c.aap_tecnologia, c.aap_potencia, ap.aap_potenciareal, c.cantidad, c.retirada, c.instalada FROM siap.carga c
                        ...
                        _raaps.map { aap => 
                                    j += 1
                                    _listRow += com.norbitltd.spoiwo.model.Row(
                                                StringCell(aap._1.get, Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(aap._2.get, Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(aap._3 match { case Some(value) => value case None => 0 }, Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(aap._4.get.doubleValue(), Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                FormulaCell("+D"+j+"*C"+j,Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(aap._5.get.doubleValue(), Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(aap._6.get.doubleValue(), Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),                                                                                                 
                                                FormulaCell("+G"+j+"-F"+j,Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                FormulaCell("+D"+j+"+H"+j,Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                FormulaCell("+I"+j+"*C"+j,Some(9), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                FormulaCell("+J"+j+"/1000",Some(10), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(12, Some(11), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),
                                                NumericCell(fecha_final.getActualMaximum(Calendar.DATE), Some(12), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),          
                                                FormulaCell("+K"+j+"*L"+j+"*M"+j,Some(13), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                                ),                                     
                                    )
                                }
                                
                                _listRow += com.norbitltd.spoiwo.model.Row(
                                    StringCell("Cuenta No. " + cuenta, Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"), fillForegroundColor = Color.Yellow, fillPattern = CellFill.Solid)), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),   
                                    FormulaCell("SUM(D"+fila_suma_inicial+":D"+j+")",Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ...
                                    FormulaCell("SUM(I"+fila_suma_inicial+":I"+j+")",Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    FormulaCell("SUM(J"+fila_suma_inicial+":J"+j+")",Some(9), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    FormulaCell("SUM(K"+fila_suma_inicial+":K"+j+")",Some(10), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ), 
                                    StringCell("", Some(11), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(12), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    FormulaCell("SUM(N"+fila_suma_inicial+":N"+j+")",Some(13), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ), 
                                    StringCell("", Some(14), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    StringCell("", Some(15), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    NumericCell(512, Some(16), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ), 
                                    FormulaCell("+N"+(j+1)+"*R7",Some(17), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    FormulaCell("+(N"+(j+1)+"-R"+(j+1)+")*Q"+(j+1),Some(18), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),
                                    FormulaCell("+S"+(j+1),Some(19), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                                    ),                                                                        
                                )       
                    ...
                    var cadena = ""
                    rangos.foreach { r => cadena += "SUM(E"+r._1+":E"+r._2+")+" }
                    ...
                    _listRow += com.norbitltd.spoiwo.model.Row(
                        StringCell("TOTALES ", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"), fillForegroundColor = Color.Yellow, fillPattern = CellFill.Solid)), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),   
                        FormulaCell("SUM("+filas_suma_total+")",Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        FormulaCell(cadena,Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        FormulaCell(cadena2,Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        FormulaCell(cadena3,Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        FormulaCell(cadena4,Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        FormulaCell("SUM("+filas_suma_total.replace("D","I")+")",Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),   
                        FormulaCell("SUM("+filas_suma_total.replace("D","J")+")",Some(9), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),  
                        StringCell("", Some(10), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        StringCell("", Some(11), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        StringCell("", Some(12), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        FormulaCell("SUM("+filas_suma_total.replace("D","N")+")",Some(13), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        StringCell("", Some(14), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        StringCell("", Some(15), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),                        
                        StringCell("TOTAL $", Some(16), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),                        
                        FormulaCell("SUM("+filas_suma_total.replace("D","R")+")",Some(17), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        FormulaCell("SUM("+filas_suma_total.replace("D","S")+")",Some(18), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ), 
                        FormulaCell("SUM("+filas_suma_total.replace("D","T")+")",Some(19), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),                                                                                                                                                                                                                         
                    )    
                }
            j +=1
            ...
            fila_suma_inicial = j
            var medidor = SQL("""SELECT c.aap_tecnologia, c.aap_potencia, ap.aap_potenciareal, c.cantidad, c.retirada, c.instalada FROM siap.carga c
            LEFT JOIN siap.aap_potenciareal ap ON ap.aapr_tecnologia = c.aap_tecnologia AND ap.aapr_potencia = c.aap_potencia
            WHERE c.aaco_id = {aaco_id} AND c.empr_id = {empr_id} and c.zanho = {zanho} and c.zperiodo = {zperiodo}
            ORDER BY c.aap_tecnologia DESC, c.aap_potencia""").on(
                'empr_id -> empr_id,
                'aaco_id -> 2,
                'zanho -> anho,
                'zperiodo -> periodo
            ...
            _listRow += com.norbitltd.spoiwo.model.Row(
                StringCell("TOTAL BAJO MEDIDA", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"), fillForegroundColor = Color.Yellow, fillPattern = CellFill.Solid)), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
            ...
            j+=1  
            _listRow += com.norbitltd.spoiwo.model.Row(
                StringCell("GRAN TOTAL INVENTARIO", Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"), fillForegroundColor = Color.Yellow, fillPattern = CellFill.Solid)), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                StringCell("", Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                StringCell("", Some(2), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),   
                FormulaCell("SUM(D"+(fila_suma_inicial-1)+",D"+j+")",Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                FormulaCell("SUM(E"+(fila_suma_inicial-1)+",E"+j+")",Some(4), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                FormulaCell("SUM(F"+(fila_suma_inicial-1)+",F"+j+")",Some(5), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ),
                FormulaCell("SUM(G"+(fila_suma_inicial-1)+",G"+j+")",Some(6), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ), 
                FormulaCell("SUM(H"+(fila_suma_inicial-1)+",H"+j+")",Some(7), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ), 
                FormulaCell("SUM(I"+(fila_suma_inicial-1)+",I"+j+")",Some(8), style = Some(CellStyle( dataFormat = CellDataFormat("#,##0"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                ) 
            )    
            ...
            var columnstyle = {
                _listColumn += com.norbitltd.spoiwo.model.Column(index = 0, width = new Width(50, WidthUnit.Character))
                _listColumn.toList
            }
            val sheet1 = Sheet(name="HojaT", rows = _listRow.toList, mergedRegions = mergedColumns, columns = columnstyle)
            ...
            empresa match {
                case Some(empresa) =>
                    ...
                    val resultSet = SQL("""SELECT m.medi_id, m.medi_numero, m.medi_direccion, ac.aacu_descripcion, COUNT(a.*) AS cantidad FROM siap.medidor m
                                 ...
                                 .as(_mParser.*)
                    val sheet1 = Sheet(name="Medidores",
                        rows = {
                            val title1Row = com.norbitltd.spoiwo.model.Row().withCellValues(empresa.empr_descripcion)
                            val title2Row = com.norbitltd.spoiwo.model.Row().withCellValues("INFORME DE MEDIDORES")
                            val title3Row = com.norbitltd.spoiwo.model.Row().withCellValues("GENERADO EL " + format.format(Calendar.getInstance().getTime()) )
                            val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Número", "Dirección", "Cuenta Alumbrado","Cantidad")
                            var j = 2
        ...
        db.withConnection {  implicit connection =>
            ...
            empresa match {
                case Some(empresa) =>
                    ...
                    val _mParser = int("tran_id") ~ str("tran_numero") ~ str("tran_direccion") ~ str("barr_descripcion") ~ int("cantidad") map { case a ~ b ~ c ~ d ~ e => (a,b,c,d,e) }
                    val resultSet = SQL("""SELECT m.tran_id, m.tran_numero, m.tran_direccion, b.barr_descripcion, COUNT(a.*) AS cantidad FROM siap.transformador m
                                 ...
                                 .as(_mParser.*)
                    val sheet1 = Sheet(name="Transformadores",
                        rows = {
                            val title1Row = com.norbitltd.spoiwo.model.Row().withCellValues(empresa.empr_descripcion)
                            val title2Row = com.norbitltd.spoiwo.model.Row().withCellValues("INFORME DE TRANSFORMADORES")
                            val title3Row = com.norbitltd.spoiwo.model.Row().withCellValues("GENERADO EL " + format.format(Calendar.getInstance().getTime()) )
                            val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Número", "Dirección", "Barrio", "Cantidad")
                            var j = 2
                            val rows = resultSet.map { med => 
                                j+=1
    ...
    def siap_ucap_xls(fecha_inicial: Long, fecha_final: Long, empr_id: Long): Array[Byte] = {
        db.withConnection { implicit connection => 
            val empresa = empresaService.buscarPorId(empr_id)
            empresa match {
                case Some(empresa) =>
            ...
            val fi = new DateTime(fecha_inicial)
            val ff = new DateTime(fecha_final)
            val _uParser = int("ucap_id") ~ str("ucap_descripcion") ~ double("cantidad") map { case a ~ b ~ c => (a,b,c) }
            val resultSet = SQL("""SELECT u.ucap_id, u.ucap_descripcion, SUM(re.even_cantidad_instalado) as cantidad FROM siap.ucap u 
            ...
            val sheet1 = Sheet(name="UCAPs",
            rows = {
                val title1Row = com.norbitltd.spoiwo.model.Row().withCellValues(empresa.empr_descripcion)
                val title2Row = com.norbitltd.spoiwo.model.Row().withCellValues("INFORME DE UNIDADES CONSTRUCTIVAS")
                val title3Row = com.norbitltd.spoiwo.model.Row().withCellValues("GENERADO EL " + format.format(Calendar.getInstance().getTime()) )
                val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Uid", "Unidad Construtiva", "Cantidad")
                var j = 2
                val rows = resultSet.map { u => 
                    j+=1
                    val link = new HyperLinkUrl(u._1.toString, "#U" +u._1)
                    com.norbitltd.spoiwo.model.Row(
                        HyperLinkUrlCell(link ,Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        StringCell(u._2 ,Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                        NumericCell(u._3 ,Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0.00"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                        ),
                    )
                }
            title1Row :: title2Row :: title3Row :: headerRow :: rows.toList
        ...
        var _listSheet = new ListBuffer[Sheet]()
        _listSheet += sheet1
        val _ueParser = str("elem_codigo") ~ str("elem_descripcion") ~ double("cantidad") map { case a ~ b ~ c => (a,b,c) }

        resultSet.map { e =>
            val fmt = DateTimeFormat.forPattern("yyyyMMdd")
            val sheet = Sheet(name="U" + e._1,
                rows = { 
                    val headerRow = com.norbitltd.spoiwo.model.Row().withCellValues("Código",
                                                         "Material", 
                                                         "Cantidad")
                    val elemSet = SQL("""SELECT
                            e.elem_codigo,
                            e.elem_descripcion,
                    ...
                    val rows = elemSet.map { i => 
                        com.norbitltd.spoiwo.model.Row(
                            StringCell(i._1 ,Some(0), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                            ),
                            StringCell(i._2 ,Some(1), style = Some(CellStyle( dataFormat = CellDataFormat("@"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                            ),
                            NumericCell(i._3 ,Some(3), style = Some(CellStyle( dataFormat = CellDataFormat("#0.00"))), CellStyleInheritance.CellThenRowThenColumnThenSheet
                            )
                        )
                    }
                    headerRow :: rows.toList
